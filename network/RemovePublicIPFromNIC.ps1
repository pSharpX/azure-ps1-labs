...
"Dissociating Public IP Address ($PublicIPAddress.Name) from Network Interface Ip Config ($NetworkInterfacePrimaryIpConfig.Name)"
$NetworkInterface | Set-AzNetworkInterfaceIpConfig -Name $NetworkInterfacePrimaryIpConfig.Name -PublicIpAddress $null
